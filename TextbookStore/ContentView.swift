...
struct ContentView: View {
    ...
    let books = [
        Book(title: "Prinplces of enginer", subject: "Math", edition: 3, authors: ["Sam GoodsBugr"]),
        Book(title: "History of the world", subject: "History", edition: 4, authors: ["Leonard Lee"]),
        Book(title: "Spainsh 101", subject: "Other", edition: 9, authors: ["Maria Gonzulezs"])
